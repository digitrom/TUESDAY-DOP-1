...
function App() {
    ...
    function changeFilter(todolistId: string, value: FilterValuesType) {
        ...
        // setTasks({...tasks, [todolistId]:{...tasks[todolistId], data:[...tasks[todolistId]], filter: value}})
        // setTasks({...tasks, [todolistId]:{...tasks[todolistId], data: [...tasks[todolistId].data], filter: value}})
